                                        ...
                                        <table class="table table-light table-bordered table-rounded mb-5">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="property-value" aria-labelledby="title-label">${poi.title}</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="text-end">
                                                ...
                                                <tr>
                                                    <th class="text-end">
                                                        <span id="lat-label" class="property-label">Lat</span>
                                                    </th>
                                                    <td>
                                                        <div class="property-value" aria-labelledby="lat-label">${poi.lat}</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="text-end">
                                                        <span id="lng-label" class="property-label">Lng</span>
                                                    </th>
                                                    <td>
                                                        <div class="property-value" aria-labelledby="lng-label">${poi.lng}</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="text-end">
                                                ...
                                                <tr>
                                                    <th class="text-end">
                                                        <span id="pathway-label" class="property-label">Pathway</span>
                                                    </th>
                                                    <td><div class="property-value" aria-labelledby="pathway-label"><a
                                                            href="/pathway/show/${poi.pathway.id}">${poi.pathway.title}</a></div></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <g:form resource="${this.poi}" method="DELETE">
                                            <fieldset class="buttons text-center">
                                                <g:link class="save btn btn-lg  bg-primary my-2 text-white px-5" action="edit" resource="${this.poi}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
